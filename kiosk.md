...
```{admonition} Feature Withdrawn
:class: tip
Due to changes in Android and Apple IOS, this feature can no longer be supported.
```
...
clicking the <span class="sd-badge sd-bg-primary sd-pill sd-text-white">**New Event+**</span> button at the top right of 
...
Once you've entered the details, click <span class="sd-badge sd-bg-primary sd-pill sd-text-white">**Submit**</span> (top left), 
...
<img src="assets/images/signin.jpg" alt="Kiosk sign-in" width="50px" class="mb-1">

Kiosk sign-in icon
:::

You can sign-out without a tag by clicking the <span class="sd-badge sd-bg-success sd-pill sd-text-white">**Sign Out**</span> button next to your name.
...
Click <span class="sd-badge sd-bg-primary sd-pill sd-text-white">**Submit**</span> when done, 
and the revised event will appear on the Kiosk.
...
* Member qualifications can be reviewed using the <span class="sd-badge sd-bg-warning sd-pill">**T-Card**</span>
...
Click <span class="sd-badge sd-bg-primary sd-pill sd-text-white">**Submit**</span> to save the new details.
...
The <span class="sd-badge sd-bg-info sd-pill sd-text-white">**Transfer**</span> button, available in the form used to 
...
Then click the <span class="sd-badge sd-bg-info sd-pill sd-text-white">**Transfer**</span> button at the top right. 
...
<span class="sd-badge sd-bg-primary sd-pill sd-text-white">**Submit**</span> the Transfer form with the new details, 
...
<span class="sd-badge sd-bg-warning sd-pill">**T-Card**</span> button. 
